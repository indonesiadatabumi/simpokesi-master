...
-- ----------------------------
INSERT INTO `hiburan_jenis_ruangans` VALUES (1, 7, 'Large', '200000', 5, 10, '10:00 - 17:00', '10:00 - 18:00', 4, 8, 262800000);
INSERT INTO `hiburan_jenis_ruangans` VALUES (2, 7, 'Medium', '150000', 10, 4, '10:00 - 17:00', '10:00 - 14:00', 2, 5, 114975000);
INSERT INTO `hiburan_jenis_ruangans` VALUES (3, 7, 'Small', '350000', 15, 6, '10:00 - 16:00', '10:00 - 17:00', 2, 6, 306600000);
INSERT INTO `hiburan_jenis_ruangans` VALUES (4, 8, 'VIP', '200000', 5, 0, '00:00 - 00:00', '00:00 - 00:00', 4, 8, 219000000);
INSERT INTO `hiburan_jenis_ruangans` VALUES (5, 8, 'Suite', '350000', 15, 0, '00:00 - 00:00', '00:00 - 00:00', 2, 6, 255500000);
INSERT INTO `hiburan_jenis_ruangans` VALUES (6, 8, 'Standard', '150000', 10, 0, '00:00 - 00:00', '00:00 - 00:00', 2, 5, 95812500);
...
CREATE TABLE `hiburan_jenises`  (
  ...
  `hiburan_jenis_have_multiple_kunjungan` tinyint(1) NULL DEFAULT 0,
  ...
  `hiburan_jenis_kunjungan_label` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `hiburan_jenis_kunjungan_unit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `hiburan_jenises` VALUES (1, 'Bioskop', 10.00, 0, 1, 0, 'bioskop', 'Studio', 'Unit', 'Kunjungan Per Studio', 'Orang', 'Total Kursi Keseluruhan', 'Kursi', 'HTM', 'Orang', 'film', NULL, NULL);
INSERT INTO `hiburan_jenises` VALUES (2, 'Diskotik, Klub, PUB, dll.', 40.00, 0, 0, 0, 'diskotik', NULL, NULL, NULL, NULL, 'Kapasitas Maksimal Diskotik', 'Orang', 'Rata - Rata Pengeluaran Tamu', NULL, 'moon-o', NULL, NULL);
INSERT INTO `hiburan_jenises` VALUES (3, 'Arena Ketangkasan', 10.00, 0, 0, 0, 'pacuan_kuda_motor', NULL, NULL, NULL, NULL, 'Kapasitas Maksimal', 'Orang', 'HTM', 'Orang', 'flag-checkered', NULL, NULL);
INSERT INTO `hiburan_jenises` VALUES (4, 'Permainan Anak', 10.00, 0, 1, 1, 'permainan_anak', NULL, NULL, NULL, NULL, NULL, NULL, 'HTM', 'Orang', 'gamepad', NULL, NULL);
INSERT INTO `hiburan_jenises` VALUES (5, 'Permainan Ketangkasan Anak', 25.00, 0, 0, 0, 'wahana_ketangkasan', 'Alat yang digunakan dalam sekali kunjungan', 'Unit', NULL, NULL, 'Alat Permainan', 'Unit', 'Harga Rata - Rata Sewa Alat', 'Unit', 'gamepad', 'Rata - Rata Lama Bermain', 'Jam');
INSERT INTO `hiburan_jenises` VALUES (6, 'Karaoke', 30.00, 1, 0, 0, 'karaoke', NULL, NULL, 'Penggunaan Room', 'Kali', NULL, NULL, 'HTM', NULL, 'microphone', NULL, NULL);
INSERT INTO `hiburan_jenises` VALUES (7, 'Panti Pijat', 10.00, 1, 0, 0, 'panti_pijat', NULL, NULL, NULL, NULL, NULL, NULL, 'HTM', 'Kunjungan', 'user', NULL, NULL);
INSERT INTO `hiburan_jenises` VALUES (8, 'Fitness', 25.00, 0, 0, 0, 'fitness', NULL, NULL, NULL, NULL, 'Kapasitas Maksimal Fitness', 'Orang', 'HTM', 'Orang', 'smile', NULL, NULL);
INSERT INTO `hiburan_jenises` VALUES (9, 'Billiard', 25.00, 0, 0, 0, 'billiard', 'Meja Billiard', 'Unit', 'Penggunaan Meja', 'Kali', NULL, NULL, 'HTM', 'Kunjungan', 'dot-circle-o', NULL, NULL);
...
-- ----------------------------
-- Table structure for hiburan_kunjungan_values
-- ----------------------------
DROP TABLE IF EXISTS `hiburan_kunjungan_values`;
CREATE TABLE `hiburan_kunjungan_values`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `hiburan_id` bigint NULL DEFAULT NULL,
  `hiburan_kunjungan_id` bigint NULL DEFAULT NULL,
  `hiburan_kunjungan_weekends_value` double NULL DEFAULT 0,
  `hiburan_kunjungan_weekdays_value` double NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `hiburan_kunjungan_values_hiburan_kunjungan_id_hiburan_id_unique`(`hiburan_kunjungan_id`, `hiburan_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of hiburan_kunjungan_values
-- ----------------------------
INSERT INTO `hiburan_kunjungan_values` VALUES (1, 4, 1, 500, 300);
INSERT INTO `hiburan_kunjungan_values` VALUES (2, 4, 2, 1000, 400);
INSERT INTO `hiburan_kunjungan_values` VALUES (3, 15, 1, 50, 20);
INSERT INTO `hiburan_kunjungan_values` VALUES (4, 15, 2, 50, 20);

-- ----------------------------
-- Table structure for hiburan_kunjungans
-- ----------------------------
DROP TABLE IF EXISTS `hiburan_kunjungans`;
CREATE TABLE `hiburan_kunjungans`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `hiburan_jenis_id` bigint NULL DEFAULT NULL,
  `hiburan_kunjungan_deskripsi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of hiburan_kunjungans
-- ----------------------------
INSERT INTO `hiburan_kunjungans` VALUES (1, 4, 'Dewasa');
INSERT INTO `hiburan_kunjungans` VALUES (2, 4, 'Anak');
...
INSERT INTO `hiburan_tarif_values` VALUES (10, 4, 1, 100000);
INSERT INTO `hiburan_tarif_values` VALUES (11, 4, 2, 50000);
INSERT INTO `hiburan_tarif_values` VALUES (12, 1, 3, 35000);
INSERT INTO `hiburan_tarif_values` VALUES (13, 1, 4, 50000);
INSERT INTO `hiburan_tarif_values` VALUES (24, 15, 1, 75000);
INSERT INTO `hiburan_tarif_values` VALUES (25, 15, 2, 100000);
...
INSERT INTO `hiburan_tarifs` VALUES (3, 1, 'Hari Kerja');
INSERT INTO `hiburan_tarifs` VALUES (4, 1, 'Hari Libur');
...
-- ----------------------------
INSERT INTO `hiburan_tingkat_kunjungan_avgs` VALUES (1, 1, 105, 260, 100, 50);
INSERT INTO `hiburan_tingkat_kunjungan_avgs` VALUES (2, 2, 105, 260, 100, 50);
INSERT INTO `hiburan_tingkat_kunjungan_avgs` VALUES (3, 3, 150, 15, 1700, 150);
INSERT INTO `hiburan_tingkat_kunjungan_avgs` VALUES (4, 4, 105, 260, 1450, 100);
INSERT INTO `hiburan_tingkat_kunjungan_avgs` VALUES (5, 5, 200, 15, 600, 10);
INSERT INTO `hiburan_tingkat_kunjungan_avgs` VALUES (7, 7, 105, 260, 0, 0);
INSERT INTO `hiburan_tingkat_kunjungan_avgs` VALUES (8, 8, 105, 260, 0, 0);
INSERT INTO `hiburan_tingkat_kunjungan_avgs` VALUES (9, 9, 105, 260, 100, 50);
...
INSERT INTO `hiburan_tingkat_kunjungan_avgs` VALUES (12, 12, 105, 260, 6, 4);
INSERT INTO `hiburan_tingkat_kunjungan_avgs` VALUES (13, 13, 105, 260, 25, 8);
INSERT INTO `hiburan_tingkat_kunjungan_avgs` VALUES (14, 14, 105, 260, 25, 8);
INSERT INTO `hiburan_tingkat_kunjungan_avgs` VALUES (15, 15, 105, 260, 0, 0);
INSERT INTO `hiburan_tingkat_kunjungan_avgs` VALUES (16, 16, 105, 260, 100, 50);
...
-- Records of hiburans
-- ----------------------------
INSERT INTO `hiburans` VALUES (1, 'Ilham', '67812637812632132', 'Bioskop XXI Ciwastra', 'JL. GBI BLOK G8 NO. 89', 'BANTARGEBANG', 'CIKIWUL', '009', '001', 4, 100, 50000, NULL, NULL, '10:00 - 17:00', '10:00 - 14:00', 799000000, 10, '087822112222', '2022_BIOSKOP_0107252022.png', '-6.345326728078956', '106.98863983154298', 1, 1, NULL, 1, NULL, '2022-07-25 02:37:55', '2022-08-25 01:15:12');
INSERT INTO `hiburans` VALUES (2, 'Ilham', '127836217368123', 'Moxy', 'JL. SOEKARNO HATTA NO. 78', 'BEKASI BARAT', 'KOTABARU', '007', '008', NULL, 100, 150000, NULL, NULL, '00:00 - 23:59', '00:00 - 23:59', 1410000000, 40, '087822617777', '2022_DISKOTIK_0207252022.png', '-6.2471954994279555', '106.95326685905458', 1, 2, 1, 1, NULL, '2022-07-25 02:56:32', '2022-08-25 01:17:50');
...
INSERT INTO `hiburans` VALUES (4, 'Ilham', '61728361273', 'Timezone Citayem', 'JL. CITAYEM', 'BANTARGEBANG', 'CIKIWUL', '030', '020', NULL, 678, 100000, NULL, NULL, '14:00 - 18:00', '14:00 - 18:00', 9581250000, 25, '087822217777', '2022_PERMAINAN_ANAK_0407252022.png', '-6.340549632917069', '106.99138641357422', 1, 4, 9, 1, NULL, '2022-07-25 03:57:37', '2022-08-25 00:13:10');
INSERT INTO `hiburans` VALUES (7, 'Ilham', '12783612783', 'Karaoke hamayat', 'KOMP. GBI BLOK G78 NO. 90', 'BEKASI BARAT', 'JAKASAMPURNA', '007', '009', 12, NULL, NULL, NULL, NULL, NULL, NULL, 684375000, 30, '087822918888', '2022_KARAOKE_0707272022.jpeg', '-6.222473157416403', '106.96323394775392', 1, 6, NULL, 1, NULL, '2022-07-27 02:24:57', '2022-08-25 01:47:13');
INSERT INTO `hiburans` VALUES (8, 'Ilham', '16278361723781', 'Ilham\'s Pijat Refleksi', 'KOMP. GBI BLOK G9 NO. 77', 'JATIASIH', 'JATIMEKAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 570312500, 25, '087821901111', '2022_PANTI_PIJAT_0807272022.jpg', '-6.346009166630132', '106.92890167236328', 1, 7, 18, 1, NULL, '2022-07-27 02:45:52', '2022-08-25 01:54:02');
INSERT INTO `hiburans` VALUES (9, 'Ilham', NULL, 'Hamayat ATV', 'KOMP. GBI BLOK G1 NO. 123', 'BEKASI SELATAN', 'KAYURINGINJAYA', NULL, NULL, NULL, 100, 150000, NULL, NULL, '00:00 - 23:59', '00:00 - 23:59', 352500000, 10, NULL, NULL, '-6.250459017393361', '106.98177337646486', 1, 3, 6, 1, NULL, '2022-07-27 02:54:57', '2022-08-25 01:21:07');
...
INSERT INTO `hiburans` VALUES (12, 'Ilham', '123123123123123', 'Billiard 99', 'KOMP. GEDEBAGE NO. 15', 'BANTARGEBANG', 'BANTARGEBANG', NULL, NULL, 4, 222, 50000, NULL, NULL, '00:00 - 00:00', '00:00 - 00:00', 83500000, 25, '087824441827', '2022_BILLIARD_01208052022.jpg', '-6.3350900413976925', '106.99207305908203', 1, 9, NULL, 1, NULL, '2022-08-05 01:27:41', '2022-08-25 01:40:56');
INSERT INTO `hiburans` VALUES (13, 'Herjunot Ali', '263781623781263', 'Flying Fox Bekasi', 'KOMP. BANTARGEBANG', 'BANTARGEBANG', 'BANTARGEBANG', '09', '01', 3, 6, 15000, 2.00, NULL, '10:00 - 16:00', '10:00 - 15:00', 105862500, 25, '087828188899', '2022_WAHANA_KETANGKASAN_01308052022.jpg', '-6.338502292868852', '106.99619293212892', 1, 5, NULL, 1, NULL, '2022-08-05 03:04:00', '2022-08-25 01:25:15');
...
INSERT INTO `hiburans` VALUES (15, 'Sari', '671283612783612', 'Kidzill', 'JL. RAYA HANKAM KAV. 69', 'BEKASI BARAT', 'JAKASAMPURNA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '10:00 - 18:00', '10:00 - 18:00', 914375000, 25, '087784773417', '2022_PERMAINAN_ANAK_01508252022.png', '-6.354198358705802', '106.92237854003908', 1, 4, 10, 1, NULL, '2022-08-25 00:27:25', '2022-08-25 01:24:25');
INSERT INTO `hiburans` VALUES (16, 'Irda', NULL, 'Gym Bord', 'JL. RAYA HANKAM KAV. 69', 'BANTARGEBANG', 'CIKETINGUDIK', NULL, NULL, NULL, 100, 150000, NULL, NULL, '00:00 - 23:59', '00:00 - 23:59', 881250000, 25, '087784773417', NULL, '-6.248411322225335', '106.99138641357422', 1, 8, NULL, 1, NULL, '2022-08-25 01:27:17', '2022-08-25 01:27:17');
...
INSERT INTO `migrations` VALUES (58, '2022_08_24_223003_alter_hiburan_jenises_add_have_multiple_kunjungan', 30);
INSERT INTO `migrations` VALUES (59, '2022_08_25_004940_alter_hiburan_jenises_add_kunjungan_label', 31);
INSERT INTO `migrations` VALUES (60, '2022_08_25_015538_alter_users_add_kecamatan_id', 32);
...
CREATE TABLE `user_logs`  (
  ...
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1252 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `user_logs` VALUES (1247, 1, '2022-08-23 03:18:38', '2022-08-23 03:18:38');
INSERT INTO `user_logs` VALUES (1248, 1, '2022-08-24 03:54:28', '2022-08-24 03:54:28');
INSERT INTO `user_logs` VALUES (1249, 1, '2022-08-24 21:48:18', '2022-08-24 21:48:18');
INSERT INTO `user_logs` VALUES (1250, 9, '2022-08-25 02:07:27', '2022-08-25 02:07:27');
INSERT INTO `user_logs` VALUES (1251, 1, '2022-08-25 02:13:51', '2022-08-25 02:13:51');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'User Admin', 'admin', 'admin@gmail.com', NULL, '$2y$10$1XeITtCxz1IJeHmzgYnC2udoPnML2p8oqwz6BtO5/7e3tZlKyM5Iq', 1, NULL, NULL, '2021-07-07 21:51:41', '2021-07-07 21:51:41', NULL);
INSERT INTO `users` VALUES (2, 'User Surveyor', 'surveyor', 'surveyor@gmail.com', NULL, '$2y$10$1XeITtCxz1IJeHmzgYnC2udoPnML2p8oqwz6BtO5/7e3tZlKyM5Iq', 2, NULL, NULL, '2021-07-07 21:51:41', '2021-07-07 21:51:41', NULL);
INSERT INTO `users` VALUES (3, 'User Pimpinan', 'pimpinan', 'pimpinan@gmail.com', NULL, '$2y$10$1XeITtCxz1IJeHmzgYnC2udoPnML2p8oqwz6BtO5/7e3tZlKyM5Iq', 3, NULL, NULL, '2021-07-07 21:51:41', '2021-12-15 11:20:54', '2021-12-15 11:20:54');
INSERT INTO `users` VALUES (4, 'User Surveyor 2', 'surveyor2', 'surveyor2@gmail.com', NULL, '$2y$10$1XeITtCxz1IJeHmzgYnC2udoPnML2p8oqwz6BtO5/7e3tZlKyM5Iq', 2, NULL, NULL, '2021-07-07 21:51:41', '2021-07-07 21:51:41', NULL);
INSERT INTO `users` VALUES (5, 'User Pimpinan 2', 'pimpinan2', 'pimpinan2@gmail.com', NULL, '$2y$10$1XeITtCxz1IJeHmzgYnC2udoPnML2p8oqwz6BtO5/7e3tZlKyM5Iq', 3, NULL, NULL, '2021-07-07 21:51:41', '2021-12-15 11:20:48', '2021-12-15 11:20:48');
INSERT INTO `users` VALUES (6, 'Muhammad Ilham Hidayat', 'hamayat', 'hamayat123@gmail.com', NULL, '$2y$10$4HCrzr7Bg1PQKfxmW44Ev./M9pq70j2NxkFsWqc/U8zZ37BZkbxCC', 3, NULL, NULL, '2021-07-08 19:58:31', '2021-12-15 11:20:41', '2021-12-15 11:20:41');
INSERT INTO `users` VALUES (8, 'surveyor_dani', 'surveyor_dani', 'surveyor_dani@gmail.com', NULL, '$2y$10$1XeITtCxz1IJeHmzgYnC2udoPnML2p8oqwz6BtO5/7e3tZlKyM5Iq', 2, 1, NULL, '2021-10-20 21:42:59', '2021-10-20 21:42:59', NULL);
INSERT INTO `users` VALUES (9, 'adm_selatan', 'adm_selatan', 'adm_selatan@gmail.com', NULL, '$2y$10$1XeITtCxz1IJeHmzgYnC2udoPnML2p8oqwz6BtO5/7e3tZlKyM5Iq', 2, 4, NULL, '2021-12-15 11:09:27', '2022-08-25 02:07:08', NULL);
INSERT INTO `users` VALUES (10, 'adm_timur', 'adm_timur', 'adm_timur@gmail.com', NULL, '$2y$10$1XeITtCxz1IJeHmzgYnC2udoPnML2p8oqwz6BtO5/7e3tZlKyM5Iq', 2, 3, NULL, '2021-12-15 11:10:50', '2021-12-15 11:10:50', NULL);
INSERT INTO `users` VALUES (11, 'adm_barat', 'adm_barat', 'adm_barat@gmail.com', NULL, '$2y$10$wmLH8DPqv7zpS6SilXDhGeI348eRczS55x2v316o1gYPDueIM.KBO', 2, 4, NULL, '2021-12-15 11:11:25', '2022-07-27 05:31:25', NULL);
INSERT INTO `users` VALUES (12, 'adm_jatisampurna', 'adm_jatisampurna', 'adm_jatisampurna@gmail.com', NULL, '$2y$10$Znd75nAlzOmo0CMJJUu4dunRPRmM1cbc.j0NJ5G4RLuXtPuADTGeW', 2, 5, NULL, '2021-12-15 11:12:07', '2021-12-15 11:12:07', NULL);
INSERT INTO `users` VALUES (13, 'adm_bantargebang', 'adm_bantargebang', 'adm_bantargebang@gmail.com', NULL, '$2y$10$YHkFXTVX2uzflY22/jjqIef1sU0TajocG88CqqUUYnMNvLNcKVPkC', 2, 6, NULL, '2021-12-15 11:12:41', '2021-12-15 11:12:41', NULL);
INSERT INTO `users` VALUES (14, 'adm_utara', 'adm_utara', 'adm_utara@gmail.com', NULL, '$2y$10$VwMkAnBPPaImbKozn7n7JexbxsMRF5EALDpmK3XVVZrlD57h4JwCq', 2, 7, NULL, '2021-12-15 11:13:07', '2021-12-15 11:13:07', NULL);
INSERT INTO `users` VALUES (15, 'adm_jatiasih', 'adm_jatiasih', 'adm_jatiasih@gmail.com', NULL, '$2y$10$WfXLTclT/gejWxWpFRT6I.kV/brv2sX0a9F2ENHqfb6.tz8oEf5FO', 2, 8, NULL, '2021-12-15 11:13:24', '2021-12-15 11:13:24', NULL);
INSERT INTO `users` VALUES (16, 'adm_medansatria', 'adm_medansatria', 'adm_medansatria@gmail.com', NULL, '$2y$10$LX1mLINWFV3zIJ4sVGt67uShr8BDRchsL/LdK7hA2jyNFfSxILWhW', 2, 9, NULL, '2021-12-15 11:13:43', '2021-12-15 11:13:43', NULL);
INSERT INTO `users` VALUES (17, 'adm_mustikajaya', 'adm_mustikajaya', 'adm_mustikajaya@gmail.com', NULL, '$2y$10$3.8vMXOrfeefWL3hhDcyteixygzNT4MjVRGJF/EYsSu4dhhHWBXI2', 2, 10, NULL, '2021-12-15 11:14:00', '2021-12-15 11:14:00', NULL);
INSERT INTO `users` VALUES (18, 'adm_pondokgede', 'adm_pondokgede', 'adm_pondokgede@gmail.com', NULL, '$2y$10$E2zCrt9ei4adKIOFOLK8leI.IAnfp3aruCwUYZWnrKbKwLAXLBdd6', 2, 11, NULL, '2021-12-15 11:14:16', '2021-12-15 11:14:16', NULL);
INSERT INTO `users` VALUES (19, 'adm_rawalumbu', 'adm_rawalumbu', 'adm_rawalumbu@gmail.com', NULL, '$2y$10$/QxDyoiHCcQOn4oqX/.T6uxYmkOAW.VW7JHVHCs6rMlYULZ.jARtm', 2, 12, NULL, '2021-12-15 11:14:34', '2021-12-15 11:14:34', NULL);
INSERT INTO `users` VALUES (20, 'adm_pondokmelati', 'adm_pondokmelati', 'adm_pondokmelati@gmail.com', NULL, '$2y$10$2w3dahzjp84hRcIhcOai1ePuv9Gd.oNsLrixgZZWSbv9kS8.5D2WS', 2, 12, NULL, '2021-12-15 11:14:52', '2021-12-15 11:14:52', NULL);
