                    ...
                    <div class="card">
                        ...
                        <div class="card-body animate-chk">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('restoran.restoran_npwpd') is-invalid @enderror" name="restoran[restoran_npwpd]" type="text" placeholder="Contoh: 420938278129382" value="{{ old('restoran.restoran_npwpd', @$restoran->restoran_npwpd) }}">
