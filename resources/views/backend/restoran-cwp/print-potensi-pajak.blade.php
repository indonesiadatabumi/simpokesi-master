...
<head>
    ...
    <title>Rekapitulasi Calon Wajib Pajak Restoran</title>
    <style>
        * {
...
<body>
    <table class="data-header">
        <tr>
            ...
            <td>
                ...
                <h2 class="text-center m-0 mb-2">LAPORAN PERHITUNGAN POTENSI PAJAK RESTORAN</h2>
    ...
    <table class="data-body">
        <tr>
            ...
            <th colspan="3">Situasi Kunjungan Tamu</th>
            <th colspan="3">Tingkat Kunjungan Tamu</th>
            <th rowspan="2">Pengeluaran Rerata Tamu per Makan (Rp)</th>
