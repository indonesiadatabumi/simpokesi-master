...
*/
           ...
           //     var restoran_klasifikasi = $('#select-restoran-klasifikasi').val();
                ...
                window.open('{{ url('restoran-cwp/export?') }}&tahun=' + tahun
...
@section('title', 'Calon Wajib Pajak Makanan dan/atau Minuman')
...
@section('content')
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h3>Calon Wajib Pajak Makanan dan/atau Minuman</h3>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Calon Wajib Pajak Makanan dan/atau Minuman</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                <form method="post" enctype="multipart/form-data" action="{{ url('restoran-cwp/import') }}">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="import-modal-label">Import Data Makanan dan/atau Minuman {{ ucfirst(@request()->tipe) }}</h5>
                        <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <input type="hidden" name="restoran_tipe" value="{{ @request()->tipe }}">
                        <div class="alert alert-light dark" role="alert">
                            <p>Download file format import Makanan dan/atau Minuman {{ ucfirst(@request()->tipe) }}: <a href="{{ asset('downloads/format/restoran'.(@request()->tipe == 'online' ? '-online' : '').'.xls') }}" download>disini</a>.</p>
                        </div>
                        <div class="mb-3">
