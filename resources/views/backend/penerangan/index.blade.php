...
@push('scripts')
    <script>
        $(document).ready(function(){
            ...
            var tablePenerangan = $('.table-datatable').DataTable({
                responsive: true,
                language: {
                    search: "",
                ...
                serverSide: true,
                ajax: {
                    url: '{{ url('api/penerangan-datatable') }}',
                    data: function(d){
                        d.penerangan_klasifikasi_id = $('#select-penerangan-klasifikasi').val();
            ...
            $('#select-penerangan-klasifikasi').on('select2:select', function(){
                tablePenerangan.ajax.reload();
            });
            ...
            $('.btnExport').on('click', function(e){
                ...
                var penerangan_klasifikasi = $('#select-penerangan-klasifikasi').val();
                var tahun = $('#select-tahun').val();
                var kecamatan = $('#select-kecamatan').val();
                var statusVerifikasi = $('[name="radio-verifikasi"]:checked').val();

                window.open('{{ url('penerangan/export') }}?tahun=' + tahun
                    + (penerangan_klasifikasi ? '&penerangan_klasifikasi_id=' + penerangan_klasifikasi : '')
...
@section('title', 'Potensi Penerangan Jalan')
...
@section('content')
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h3>Potensi Pajak Penerangan Jalan</h3>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Potensi Pajak Penerangan Jalan</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 project-list">
                <div class="card">
                    <div class="row">
                        ...
                        <div class="col-auto">
                            <a class="btn btn-light" href="javascript:void(0);" data-bs-toggle="modal" data-original-title="Import Data Penerangan Jalan" data-bs-target="#import-modal">
                                <i data-feather="file-plus"></i> Import
                            </a>
                        </div>
                        @endcanany
                        <div class="col-auto">
                            <a class="btn btn-light btnExport" href="{{ url('penerangan/export') }}">
                        ...
                        <div class="col-auto ms-auto">
                            <a class="btn btn-success" href="{{ url('/penerangan/create') }}">
                                <i data-feather="plus-square"></i> Tambah Penerangan Jalan
                            </a>
                        </div>
                        @endcanany
                    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-3">Daftar Penerangan Jalan</h5>
                        <span>Berikut ini adalah daftar potensi pajak <b>Penerangan Jalan</b>.</span>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="col-form-label">Filter Klasifikasi Penerangan Jalan</label>
                                    <select class="select2-single" id="select-penerangan-klasifikasi">
                                        <option value="">SEMUA</option>
                                        @foreach($klasifikasis as $row)
                                            <option value="{{ $row->id }}">{{ $row->penerangan_klasifikasi_deskripsi }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="import-modal" tabindex="-1" role="dialog" aria-labelledby="import-modal-label" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form method="post" enctype="multipart/form-data" action="{{ url('penerangan/import') }}">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="import-modal-label">Import Data Penerangan Jalan</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <div class="row mt-2 mb-3">
                                <div class="col col-auto">
                                    <label class="mb-0 radio-input" for="radio_penerangan">
                                        <input class="radio_animated" id="radio_penerangan" type="radio" name="import_tipe" value="Penerangan" checked> <span>Import Data Penerangan Jalan</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-light dark" role="alert">
                            <p>Download file format import <span class="import-type">Penerangan Jalan</span>: <a class="form-download" href="{{ asset('downloads/format/penerangan.xls') }}" download>disini</a>.</p>
                        </div>
                    </div>
