...
<head>
    ...
    <title>Si Mpo Kesi | Error 404 Halaman Tidak Ditemukan</title>
    <!-- Google font-->
    ...
    <div class="error-wrapper">
        <div class="container"><img class="img-100" src="{{ asset('backend') }}/assets/images/other-images/sad.png" alt="">
            ...
            <div class="col-md-8 offset-md-2">
                <p class="sub-content">Halaman yang anda tuju tidak tersedia atau dipindahkan, silahkan kembali ke halaman sebelumnya.</p>
            </div>
            <div><a class="btn btn-danger-gradien btn-lg" href="{{ url('/') }}">KEMBALI</a></div>
        </div>
    </div>
    <!-- error-404 end      -->
</div>
