...
<head>
    ...
    <title>Si Mpo Kesi | Error 500 Internal Server Error</title>
    <!-- Google font-->
...
<div class="page-wrapper compact-wrapper" id="pageWrapper">
    ...
    <div class="error-wrapper">
        <div class="container"><img class="img-100" src="{{ asset('backend') }}/assets/images/other-images/sad.png" alt="">
            <div class="error-heading">
                <h2 class="headline font-primary">500</h2>
            </div>
            <div class="col-md-8 offset-md-2">
                <p class="sub-content">Halaman yang Anda tuju sedang tidak dapat diakses dikarenakan telah terjadi sesuatu pada server. Silahkan kembali ke halaman sebelumnya.</p>
            </div>
            <div><a class="btn btn-primary-gradien btn-lg" href="{{ url('/') }}">KEMBALI</a></div>
        </div>
    </div>
    <!-- error-500 end-->
</div>
