...
class RestoranCwpImport implements OnEachRow, WithHeadingRow, WithChunkReading, WithBatchInserts, WithValidation, SkipsOnFailure
{
    ...
    */
    public function onRow(Row $row)
    {
        ...
        // Set Potensi Pajak
        $row['restoran']['restoran_potensi_pajak'] = (new RestoranCwpService())->getPotensiRestoran($row);
